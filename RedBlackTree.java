...
public class RedBlackTree<T extends Comparable<T>> implements SortedCollectionInterface<T> {
    ...
    /**
     * Performs a left rotate on the provided nodes
     * 
    ...
    /**
     * Performs a right rotation on the provided nodes
     * 
     * @param child
     * @param parent
     */
   private void rightRotation(Node<T> child, Node<T> parent) {
    ...
    //     Node<T> grandparentNode = newNode.parent.parent;
        
    //     if (grandparentNode != null) {

    //         Node<T> parentNode = newNode.parent;
    //         Node<T> uncleNode = grandparentNode.leftChild;

    //         if (parentNode.isLeftChild()) uncleNode = grandparentNode.rightChild;
    ...
    //         if (uncleNode.isBlack) parentNode.isBlack = true;

    //         if (grandparentNode != root) grandparentNode.isBlack = false;
...
//         RedBlackTree<PokemonInterface> tree = new RedBlackTree<>();

//         tree.insert(new Pokemon(3, "Squirtle"));
//         tree.insert(new Pokemon(2, "Charmander"));
//         tree.insert(new Pokemon(1, "Bulbasaur"));
